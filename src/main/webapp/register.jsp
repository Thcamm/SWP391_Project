<%-- Created by IntelliJ IDEA. User: ADMIN Date: 10/1/2025 Time: 4:58 AM To
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="d-flex gap-3 flex-column flex-xl-row">
                    <a
                      href="#"
                      class="btn bsb-btn-xl btn-outline-primary w-100 px-4 py-3 d-flex align-items-center justify-content-center"
                      style="font-size: 1.25rem; height: 55px"
                    >
                      <svg
