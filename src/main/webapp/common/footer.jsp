...
<section class="footer-section">
  <section class="contact-bar">
    <div class="text-content">
      ...
      <p>
        Let our professional team help you solve all your vehicle problems.
        Contact us now to get the best service.
      </p>
    </div>
  </section>
  ...
  <footer class="main-footer">
    ...
    <p class="footer-commitment">
      Carspa is committed to bringing satisfaction and trust to customers with
      top-quality car care and beauty services.
    </p>
