...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <c:if test="${fn:contains(sessionScope.userPermissions, 'cs_access')}">
            ...
            <c:if test="${fn:contains(sessionScope.userPermissions, 'cs_access')}">
                <li class="menu-item ${fn:contains(currentPath,'/customerservice/search-customer') ? 'active' : ''}">
                    <a href="${pageContext.request.contextPath}/customerservice/search-customer" class="menu-link">
                        ...
                        <div data-i18n="Search Customer">Search Customer</div>
                    </a>
                </li>
            </c:if>
            ...
            <c:if test="${fn:contains(sessionScope.userPermissions, 'cs_view_workorders')}">
                <li class="menu-item ${fn:contains(currentPath,'/customerservice/workorders') ? 'active' : ''}">
                    <a href="${pageContext.request.contextPath}/customerservice/workorders" class="menu-link">
            ...
            <c:if test="${fn:contains(sessionScope.userPermissions, 'tech_assign_task')}">
                <li class="menu-item ${fn:contains(currentPath,'/techmanager/tasks') ? 'active' : ''}">
                    <a href="${pageContext.request.contextPath}/techmanager/tasks" class="menu-link">
                        ...
                        <div data-i18n="Assign Tasks">Assign Tasks</div>
                    </a>
                </li>
            </c:if>

            <c:if test="${fn:contains(sessionScope.userPermissions, 'tech_manage_team')}">
                <li class="menu-item ${fn:contains(currentPath,'/techmanager/team') ? 'active' : ''}">
                    <a href="${pageContext.request.contextPath}/techmanager/team" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-group"></i>
                        <div data-i18n="Manage Technicians">Manage Technicians</div>
                    </a>
                </li>
            </c:if>

            <c:if test="${fn:contains(sessionScope.userPermissions, 'tech_view_reports')}">
                <li class="menu-item ${fn:contains(currentPath,'/techmanager/reports') ? 'active' : ''}">
                    <a href="${pageContext.request.contextPath}/techmanager/reports" class="menu-link">
