<%-- Created by IntelliJ IDEA. User: ADMIN Date: 10/1/2025 Time: 4:29 AM To
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="d-flex gap-3 flex-column">
                                                <a href="${pageContext.request.contextPath}/auth/google" class="btn btn-lg btn-outline-dark">
