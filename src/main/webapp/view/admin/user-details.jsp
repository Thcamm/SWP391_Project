...
<head>
    ...
    <!-- Bootstrap (vẫn dùng cho card/table) -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet"/>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.0/font/bootstrap-icons.css" rel="stylesheet"/>

    <!-- CSS theme technician -->
    ...
    <style>
        .header + .layout, .header + main, .layout { margin-top: 14px; }
        /* Cho nội dung trang rộng như các trang khác */
        .main .page-wrap { max-width: 1200px; margin: 0 auto; }
    </style>
</head>
<body>
...
<div class="layout">
    ...
    <!-- Main content -->
    <main class="main">
        <div class="page-wrap"><!-- khung bọc để canh giữa -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div><span class="badge bg-light text-dark fs-6">${user.userId}</span></div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="h6">
                                            ...
                                            <c:if test="${user.userName == currentUser}">
                                                <span class="badge bg-warning text-dark ms-2">Current User</span>
                                            </c:if>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div><span class="badge ${user.roleBadgeClass} fs-6">${user.roleName}</span></div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <span class="badge bg-danger fs-6"><i class="bi bi-x-circle"></i> Inactive</span>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                <a href="${pageContext.request.contextPath}/admin/users/edit/${user.userId}" class="btn btn-primary">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/users/choose-type" class="btn btn-success">
                        ...
                        <div class="card-body">
                            <small class="text-muted">
                                ...
                                <c:if test="${not empty user.createdAt}">
                                    <div class="mb-2"><strong>Created:</strong> ${user.createdAt}</div>
                                </c:if>
                                <c:if test="${not empty user.updatedAt}">
                                    <div class="mb-2"><strong>Updated:</strong> ${user.updatedAt}</div>
                                </c:if>
                            </small>
                        </div>
                    </div>
