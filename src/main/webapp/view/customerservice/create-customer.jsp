    ...
    <form id="createCustomerForm" method="post" action="${pageContext.request.contextPath}/customerservice/create-customer">
        ...
        <div class="card">
            ...
            <div class="card-content">
                ...
                <div class="form-group">
                    <label for="addressDetail">Địa chỉ chi tiết <span class="required">*</span></label>
                    ...
                    <div>
                        <label class="toggle-label">
                            <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                 viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                 stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M19 17h2c.6 0 1-.4 1-1v-3
                        ...
                        <p class="toggle-description">Bật để nhập thông tin xe của khách hàng</p>
                    </div>
                    <label class="switch">
        ...
        <!-- Danh sách xe -->
        <div id="vehiclesSection" class="vehicles-section" style="display: none;">
