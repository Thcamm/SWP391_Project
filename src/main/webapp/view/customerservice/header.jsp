    ...
    <header class="header">
      ...
      >
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            >
              ...
              <li>
                <a
                  ...
                  href="${pageContext.request.contextPath}/accountant/notifications"
          ...
          <div class="dropdown">
            <a
              class="d-flex align-items-center text-decoration-none dropdown-toggle-custom"
              role="button"
              data-bs-toggle="dropdown"
              aria-expanded="false"
              style="
            ...
            >
              <div class="text-end">
                <div
                  style="font-size: 12px; color: #6b7280; margin-bottom: 2px"
                >
                  Welcome back,
                </div>
                <div style="font-weight: 600; color: #111827; line-height: 1.2">
                  ${sessionScope.userName != null ? sessionScope.userName :
                  'User'}
                </div>
                <div style="font-size: 12px; color: #6b7280; margin-top: 2px">
                  ${sessionScope.roleName != null ? sessionScope.roleName :
                  'Accountant'}
                </div>
              </div>
              <i
