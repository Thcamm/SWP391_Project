...
<div class="container py-5">
    <div class="card shadow-lg">
        <div class="card-body">
            ...
            <form action="${pageContext.request.contextPath}/customer/editVehicle" method="post" id="vehicleForm">
                ...
                <div class="mb-3">
                    ...
                    <div id="loadingText" class="form-text text-primary" style="display:none;">Loading models...</div>
                    <div id="modelCount" class="form-text text-muted" style="display:none;"></div>
                </div>
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a href="${pageContext.request.contextPath}/customer/garage" class="btn btn-outline-secondary">
                        Back to Garage
                    </a>
