...
<head>
    ...
    <title>Customer Reviews - Auto Garage</title>
...
<div class="relative bg-gradient-to-r from-gray-900 via-gray-800 to-black py-16 overflow-hidden">
    <div class="absolute inset-0 opacity-20">
        <img src="https://images.unsplash.com/photo-1711386689622-1cda23e10217?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080"
             alt="Garage background" class="w-full h-full object-cover"/>
    </div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 text-center">
        ...
        <p class="text-lg text-gray-300 max-w-2xl mx-auto">
            See real feedback from customers who have used our services
        </p>
    </div>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="text-center md:border-r border-gray-200">
                <div class="flex items-center justify-center gap-2 mb-2">
                    ...
                    <span class="text-4xl font-semibold" id="avgRating" style="color: #5a6268">0.0</span>
                </div>
                <p class="text-base text-gray-600">
                    Average rating</p>
                <p class="text-sm text-gray-400 mt-1"><span id="totalReviews">0</span> review(s)</p>
            </div>
    ...
    <div class="mb-8 space-y-4">
        <div class="flex flex-col md:flex-row gap-4">
            ...
            <div class="flex-1 relative">
                ...
                <input type="text" id="searchInput" placeholder="Tìm kiếm theo nội dung, khách hàng, dịch vụ..."
            ...
            <div class="relative w-full md:w-64">
                <select id="sortSelect"
                    ...
                    <option value="oldest">Oldes</option>
        ...
        <div class="flex items-center gap-3 flex-wrap">
            ...
            <div id="activeFilters" class="flex items-center gap-2 flex-wrap">
                <!-- Active filter badges injected by JS -->
            </div>
            <div class="ml-auto text-gray-600 text-base" id="resultCount">
                Showing 0 / 0 reviews</div>
        </div>
    </div>
