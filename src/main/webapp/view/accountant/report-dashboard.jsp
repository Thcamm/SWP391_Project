                                    ...
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <div>
                                            ...
                                            <h3 class="mb-0" style="color: #111827; font-weight: 700;">
                                                <fmt:formatNumber value="${revenueSummary.totalInvoiced}" pattern="#,###"/> đ
                                            </h3>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <div>
                                            ...
                                            <h3 class="mb-0" style="color: #059669; font-weight: 700;">
                                                <fmt:formatNumber value="${revenueSummary.totalPaid}" pattern="#,###"/> đ
                                            </h3>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <div>
                                            ...
                                            <h3 class="mb-0" style="color: #f59e0b; font-weight: 700;">
                                                <fmt:formatNumber value="${revenueSummary.totalOutstanding}" pattern="#,###"/> đ
                                            </h3>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <div>
                                            ...
                                            <h3 class="mb-0" style="color: #dc2626; font-weight: 700;">
                                                <c:forEach var="overdue" items="${overdueReport}">
                                                    ${overdue.count}
                                                </c:forEach>
                                            </h3>
                                        </div>
                            ...
                            <div class="card" style="border: 1px solid #e5e7eb; border-radius: 12px;">
                                <div class="card-header" style="background-color: #f9fafb; border-bottom: 1px solid #e5e7eb; padding: 1.25rem;">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/accountant/report?action=revenue" class="btn btn-sm btn-outline-primary" style="border-radius: 6px;">
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <c:forEach var="status" items="${invoiceByStatus}">
                                                <tr>
                                                    ...
                                                    <td style="padding: 1rem; text-align: right;">
                                                        <strong><fmt:formatNumber value="${status.totalInvoiced}" pattern="#,###"/> đ</strong>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
                            ...
                            <div class="card" style="border: 1px solid #e5e7eb; border-radius: 12px;">
                                <div class="card-header" style="background-color: #f9fafb; border-bottom: 1px solid #e5e7eb; padding: 1.25rem;">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/accountant/report?action=customer" class="btn btn-sm btn-outline-primary" style="border-radius: 6px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 1rem; text-align: right;">
                                                            <span class="text-success fw-semibold">
                                                                <fmt:formatNumber value="${customer.totalPaid}" pattern="#,###"/> đ
                                                            </span>
                                                    </td>
                                                    <td style="padding: 1rem; text-align: right;">
                                                            <span class="${customer.outstandingBalance > 0 ? 'text-danger' : 'text-muted'}">
                                                                <fmt:formatNumber value="${customer.outstandingBalance}" pattern="#,###"/> đ
                                                            </span>
                                                    </td>
                                                </tr>
                                            </c:forEach>
