...
<html lang="en">
  <head>
    ...
    <title>
      <c:choose> <c:when test="${not empty sessionScope.roleName}">
      ${sessionScope.roleName} - Home </c:when> <c:otherwise> Home
                    ...
                    <div class="card">
                      ...
                      <div class="card-body d-flex gap-2 flex-wrap">
                        <a href="#" class="btn btn-primary"
                          ><i class="bi bi-receipt"></i> View Invoices</a
                        >
                        <a href="#" class="btn btn-success"
                          ><i class="bi bi-cash-coin"></i> Record a Payment</a
                        >
                        <a href="#" class="btn btn-info"
                          ><i class="bi bi-graph-up"></i> View Reports</a
                        >
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <p class="text-muted">
                          _Recent invoice data will be displayed here_
                        </p>
