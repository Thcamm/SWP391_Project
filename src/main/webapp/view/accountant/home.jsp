                ...
                <table class="table table-hover align-middle">
                    ...
                    <c:forEach var="invoice" items="${recentInvoices}">
                        <tr>
                            ...
                            <td>
                                <fmt:formatNumber value="${invoice.totalAmount}" type="currency" currencySymbol="" maxFractionDigits="0"/> VND
                            </td>
                            <td>
                                    <span class="badge bg-${invoice.paymentStatus eq 'Paid' ? 'success' : 'warning'}">
