 ...
 * Used by TechManager to assign DIAGNOSIS and REPAIR tasks
 */
public class TaskAssignmentDAO extends DbContext {
     ...
     * Used to view all tasks assigned for a specific WorkOrder
     */
     ...
     * Used by TechManager to see all diagnosis tasks or repair tasks
     */
    ...
    /**
     * Update task status
     * Used by Technician when starting or completing a task
     */
     ...
     */
    public List<WorkOrderDetailWithInfo> getWorkOrderDetailsNeedingDiagnosisAssignment(int techManagerId) throws SQLException {
    ...
    public static class WorkOrderDetailWithInfo {
        ...
        public java.math.BigDecimal getEstimateHours() { return estimateHours; }
        public void setEstimateHours(java.math.BigDecimal estimateHours) { this.estimateHours = estimateHours; }
        ...
        public Timestamp getWorkOrderCreatedAt() { return workOrderCreatedAt; }
        public void setWorkOrderCreatedAt(Timestamp workOrderCreatedAt) { this.workOrderCreatedAt = workOrderCreatedAt; }
    }
}
